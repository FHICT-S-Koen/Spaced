...
use tracing::{info, error, Instrument, info_span};
use tracing_subscriber::{filter::LevelFilter, EnvFilter};
use wtransport::{ServerConfig, tls::Certificate, Endpoint, endpoint::IncomingSession};
...
async fn main() -> anyhow::Result<()> {
  ...
  let config = ServerConfig::builder()
    ...
    .with_certificate(Certificate::load("srcs/services/web_transport/src/cert.pem", "srcs/services/web_transport/src/key.pem").await?)
